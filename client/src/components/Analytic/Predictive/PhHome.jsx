...
import circleOutlineAnimation from '../../../img/wired-outline-447-water-yellow-drop.json';
    ...
    return (
      <div className="predictHome-container">
          {nextDayPrediction ? (
              ...
              <p className='home-result'>{parseFloat(nextDayPrediction.value).toFixed(2)} pH</p>
