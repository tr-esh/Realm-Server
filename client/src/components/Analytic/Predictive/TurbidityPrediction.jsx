...
const TurbidityPrediction = () => {
    ...
    const fetchData = async () => {
      try {
          const predictionsRes = await fetch(`/api/realm/predictions/turbidity`);
    ...
    return predictions.values.map((value, index) => {
        ...
        return {
            ...
            predictedTurbidity: parseFloat(value.toFixed(2))
        };
    });
}, [predictions]);
            ...
            <ResponsiveContainer>
                <AreaChart data={processedData}>
                    ...
                    <Area
                        ...
                        dot={{ r: 3 }}
                        >
                        <LabelList dataKey="predictedTurbidity" position="top"
